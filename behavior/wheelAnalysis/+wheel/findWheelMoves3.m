function [inMove, moveOnsets, moveOffsets, moveAmps, peakVelTimes] = findWheelMoves3(pos, t, Fs, varargin)
...
addParameter(p, 'posThresh', 2, validator);
...
addParameter(p, 'minGap', 0.2, validator);
