function data = MK_readTiffFast(fileName, options, fInfo)
% this is written by MK and given to me by JL on 3/6/2021
...
if any(diff(diff([fInfo.Offset])))
    ...
    % I don't actually have any data to properly debug this part...
