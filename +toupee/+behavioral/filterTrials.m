...
%   expInfo = toupee.meta.filterTrials(expInfo, 'concordantHigh',...
%                                      conditions1)
%   expInfo = toupee.meta.filterTrials(expInfo, 'concordantHighCorrect',...
%                                      conditions2)
%   expInfo = toupee.meta.filterTrials(expInfo, 'concordantLowCorrect',...
%                                      conditions3)
% 
...
for e = 1:numel(expInfo)
    ...
    if isfield(conditions, 'circaBlockSwitch')
        if ~isfield(conditions, 'nTrialsCirca')
            warning('toupee:behavioral:filterTrials:missingInput',... 
