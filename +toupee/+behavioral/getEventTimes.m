...
for iE = 1:nE
    ...
    % Get durations of 'interactiveOn' periods if got 'stimulusOn' and
    % 'interactiveOn' times.
    if sum(contains(curEventTimes.Properties.RowNames,...
                    ["stimulusOn", "interactiveOn"])) == 2
        curEventTimes.('signalsTimes'){'interactiveDur'} =...
            curEventTimes.('signalsTimes'){'interactiveOn'}...
            -  curEventTimes.('signalsTimes'){'stimulusOn'};
        curEventTimes.('rigTimes'){'interactiveDur'} =...
            curEventTimes.('rigTimes'){'interactiveOn'}...
            -  curEventTimes.('rigTimes'){'stimulusOn'};
    end
