...
sLhit_trials = trialTypes.intVar.cb2D.side_direction{1,1};
sRhit_trials = trialTypes.intVar.cb2D.side_direction{3,2};
sLmiss_trials = trialTypes.intVar.cb2D.side_direction{1,2};
sRmiss_trials = trialTypes.intVar.cb2D.side_direction{3,1};
...
% jitter = 0;
xPositions1 = jitter+ones(1,24)*A1;
xPositions2 = jitter+ones(1,24)*A2;
xPositions3 = jitter+ones(1,24)*B1;
xPositions4 = jitter+ones(1,24)*B2;
...
if signrank(yValues1,yValues2) <= 0.0001
    ...
    line([A1 A2],[height height],'Color','k')
...
if signrank(yValues3,yValues4) <= 0.0001
    ...
    set(h,'Color','k','HorizontalAlignment', 'center','FontSize',8);
    line([B1 B2],[height height],'Color','k')
